...
### bavaan-agentforge · v2.1.0 · Powered by Claude (Anthropic)
...
│
├── ai-skills/v2.1.0/            ← Versioned Prompt Registry
...
cd ai-skills/v2.1.0 && zip -r bavaan-skills.zip .
