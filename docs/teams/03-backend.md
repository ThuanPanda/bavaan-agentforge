...
## AgentForge v1.0.0 · NestJS / Prisma / Multi-Tenant
...
Upload: ai-skills/v1.0.0/backend/bavaan-backend-skills.zip
...
*Cần hỗ trợ: #backend trên Teams · Xem [multi-tenant-patterns.md](../../ai-skills/v1.0.0/_shared/references/multi-tenant-patterns.md)*
